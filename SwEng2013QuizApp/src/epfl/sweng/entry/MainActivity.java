...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * this.getApplicationContext()); int dummySessionID = 21;
		 * persistentStorage.takeAuthentification(dummySessionID); if
		 * (persistentStorage.isAuthentificated(21)) { Toast.makeText(this,
		 * "Authentificated", Toast.LENGTH_SHORT).show(); } else {
